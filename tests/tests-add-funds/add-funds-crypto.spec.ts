...
test('test', async ({ page }) => {
  ...
  await page.goto('https://smmpanelka.com/app/add-funds'); 
    ...
    await page.goto('https://smmpanelka.com/app/add-funds'); 
    await page.waitForTimeout(3000);
  await page.locator('xpath=/html/body/div[1]/div/div/div/div/div[9]/main/div/div[2]/div/div/div/div/div[2]/div/div[1]/div/div/div[2]/div/div[5]/div/div/div[2]').click(); 
  ...
  await page.locator('xpath=/html/body/div[1]/div/div/div/div/div[9]/main/div/div[2]/div/div/div/div/div[2]/div/div[2]/div/div/div[4]/button/span/div').click();
   await page.waitForTimeout(3000);
   await expect(page).toHaveTitle('Coinbase Commerce');
});
