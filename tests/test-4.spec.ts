...
test('test', async ({ page }) => {
  await page.goto('https://vast-service-client1.smm.rocks/ru/orders/create?serviceSlug&url=&quantity=0&networkId=0&serviceTypeId&serviceId&isDripFeed=false&dripFeedQuantityStep=100&numberOfRuns=2&dripFeedMode=flat&dripFeedMinutes=60');
  await page.goto('https://vast-service-client1.smm.rocks/ru/orders/create?serviceSlug&url&quantity=0&networkId=0&serviceTypeId&serviceId&isDripFeed=false&dripFeedQuantityStep=100&numberOfRuns=2&dripFeedMode=flat&dripFeedMinutes=60');
