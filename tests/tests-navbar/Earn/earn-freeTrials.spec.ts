...
test('Free trials page is visible', async ({ page }) => {
  ...
  test.setTimeout(0);
    ...
    await page.waitForTimeout(5000);
    await page.getByRole('link', { name: 'Free trials' }).click();
    await expect(page).toHaveURL('https://smmpanelka.com/app/free-trials');
  });