...
test('Referral program page is visible', async ({ page }) => {
  ...
  test.setTimeout(0);
    ...
    await page.waitForTimeout(5000);
    await page.getByRole('link', { name: 'Referral program' }).click();
    await expect(page).toHaveURL('https://smmpanelka.com/app/referral-program');
  });